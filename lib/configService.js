...
function processBaseConfig(config, parentModule) {
  return {
    ...
    modulePaths: [],
    moduleStubs: [],
    useBabelRegister: config.useBabelRegister || config.enableBabelRegister || config.babelRegisterConfig ? true : false,
    enableBabelRegister: config.enableBabelRegister || config.babelRegisterConfig ? true : false,
